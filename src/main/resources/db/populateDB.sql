...
INSERT INTO meals (user_id, registered, description, calories)
VALUES (100000, to_timestamp('2020-01-30 10:00', 'YYYY-MM-DD HH24:MI'), 'Завтрак', 500),
       ...
       (100000, to_timestamp('2020-01-31 10:00', 'YYYY-MM-DD HH24:MI'), 'Завтрак', 1000),
       (100000, to_timestamp('2020-01-31 13:00', 'YYYY-MM-DD HH24:MI'), 'Обед', 500),
