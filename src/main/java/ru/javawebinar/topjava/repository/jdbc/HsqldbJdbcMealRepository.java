...
public class HsqldbJdbcMealRepository extends AbstractJdbcMealRepository {
    ...
    @Override
    public MapSqlParameterSource getSaveSqlParameterSource(Meal meal, int userId) {
    ...
    public List<Meal> getBetweenHalfOpen(LocalDateTime startDateTime, LocalDateTime endDateTime, int userId) {
        return jdbcTemplate.query(
                ...
                AbstractJdbcMealRepository.ROW_MAPPER, userId, Timestamp.valueOf(startDateTime), Timestamp.valueOf(endDateTime));
    }
}
